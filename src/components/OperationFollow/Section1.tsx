...
import { updateFormField, resetForm, updateSection1 } from "@/redux/OperationFollow/reducer";
...
export default function Section1(props: Section1Props){
    ...
    //     let isValid = true
    //     const updatedData = validationState.map((item,isInvalid) => {
    ...
    return (
        <>
            <div className="d-flex form-group">
                ...
                <label>ปีงบประมาณ{formState.section1.organizationManageMent}<span style={{color:'red'}}> *</span></label>
                </div>
                <div className="d-flex flex-column form-field-fieldzone">
                    <div className="">
                        <select defaultValue={'DEFAULT'} onChange={handleChangeField} name="yearBudget" value={formState['section1']['yearBudget']} className="form-select" aria-label="Default select example" >
            ...
            <div className="d-flex form-group">
                <div className="form-field-label">
                <label>แผนบริหารจัดการองค์กร<span style={{color:'red'}}> *</span></label>
                </div>
                <div className="form-field-fieldzone">
                    <input disabled type="text" onChange={handleChangeField} name="organizationManageMent" value={formState['section1']['organizationManageMent']} className="form-control" id="exampleFormControlInput1" placeholder=""/>
                </div>
            </div>
            <div className="d-flex form-group">
                <div className="form-field-label">
                <label>แหล่งงบประมาณ<span style={{color:'red'}}> *</span></label>
                </div>
                <div className="d-flex flex-column form-field-fieldzone">
                    <div className="">
                    <input onChange={handleChangeField} name="budgetSource" value={formState['section1']['budgetSource']} type="text" className="form-control" id="exampleFormControlInput1" placeholder="" />
                    </div>
                    <div>
            ...
            <div className="d-flex form-group">
                <div className="form-field-label">
                <label>หมวด พ.ร.บ. งบประมาณ<span style={{color:'red'}}> *</span></label>
                </div>
                <div className="d-flex flex-column form-field-fieldzone">
                    <div className="">
                        <select defaultValue={'DEFAULT'} onChange={handleChangeField} name="act_group" value={formState['section1']['act_group']} className="form-select" aria-label="Default select example">
                            <option value="DEFAULT">---- เลือก ----</option>
            ...
            <div className="d-flex form-group">
                <div className="form-field-label">
                <label>รายการค่าใช้จ่าย<span style={{color:'red'}}> *</span></label>
                </div>
                <div className="d-flex flex-column form-field-fieldzone">
                    <div className="">
                    <input onChange={handleChangeField} name="paymentList" value={formState['section1']['paymentList']} type="text" className="form-control" id="exampleFormControlInput1" placeholder="" />
                    </div>
                    <div>
                        { validationState[2].isValid == false && 
                        <div className="form-field-fieldzone">
            ...
            <div className="d-flex form-group">
                <div className="form-field-label">
                <label>วัตถุประสงค์เชิงยุทธศาสตร์ (SO)<span style={{color:'red'}}> *</span></label>
                </div>
                <div className="d-flex flex-column form-field-fieldzone">
                    <div className="">
                    <select defaultValue={'DEFAULT'} onChange={handleChangeField} name="strategic_goal" value={formState['section1']['strategic_goal']} className="form-select" aria-label="Default select example">
                        <option value="DEFAULT">---- เลือก ----</option>
            ...
            <div className="d-flex form-group">
                ...
                <div className="d-flex flex-column form-field-fieldzone">
                    <div className="">
                    <select defaultValue={'DEFAULT'} onChange={handleChangeField} name="strategic" value={formState.section1.strategic} className="form-select" aria-label="Default select example">
                    <option value='DEFAULT'>---- เลือก ----</option>
                    <option value="1">One</option>
                    <option value="2">Two</option>
                    <option value="3">Three</option>
            ...
            <div className="d-flex form-group">
                <div className="form-field-label">
                <label>แผนงาน<span style={{color:'red'}}> *</span></label>
                </div>
                <div className="d-flex flex-column form-field-fieldzone">
                    <div className="">
                    <select defaultValue={'DEFAULT'} onChange={handleChangeField} name="planning" value={formState.section1.planning} className="form-select" aria-label="Default select example">
                    <option value='DEFAULT'>---- เลือก ----</option>
                    <option value="1">One</option>
                    <option value="2">Two</option>
                    <option value="3">Three</option>
                    ...
                    <div>
                        ...
                        <div className="form-field-fieldzone">
                            <span style={{color:'red'}}>โปรดกรอกข้อมูล{validationState[6].alias}</span>
                        </div>
                        }
                    </div>
                </div>
            ...
            <div className="d-flex form-group">
                ...
                <div className="d-flex flex-column form-field-fieldzone">
                    <div className="">
                    <select defaultValue={'DEFAULT'} onChange={handleChangeField} name="project_type" value={formState.section1.project_type} className="form-select" aria-label="Default select example">
                    <option value='DEFAULT'>---- เลือก ----</option>
            ...
            <div className="d-flex form-group">
                ...
                <div className="d-flex flex-column form-field-fieldzone">
                    <div className="">
                    <input type="text" onChange={handleChangeField} name="project_name" value={formState.section1.project_name} className="form-control" id="exampleFormControlInput1" placeholder="" />
                    </div>
                    <div>
                        { validationState[8].isValid == false && 
                        <div className="form-field-fieldzone">
                            <span style={{color:'red'}}>โปรดกรอกข้อมูล{validationState[8].alias}</span>
                        </div>
                        }
                    </div>
                </div>
            ...
            <div className="button-section">
                ...
                <button onClick={() => checkValidity(formState,validationState,setValidationState,setFormValid,handleSection)} type="button" className="btn btn-primary">ต่อไป <i className="bi bi-chevron-right"></i></button>
