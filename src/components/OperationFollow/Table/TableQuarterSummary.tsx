  ...
  const handleChangeField2 = (e: any) => {
    ...
    if (props.quarterSelect == 1) {
      const updateQuarter = {
        ...
        [name]: value,
        total:
          formState.section2.quarter.quarter1.month1 +
          formState.section2.quarter.quarter1.month2 +
          formState.section2.quarter.quarter1.month3,
      };
    ...
    if (props.quarterSelect == 2) {
      const updateQuarter = {
        ...
        [name]: value,
        total:
          formState.section2.quarter.quarter2.month1 +
          formState.section2.quarter.quarter2.month2 +
          formState.section2.quarter.quarter2.month3,
      };
    ...
    if (props.quarterSelect == 3) {
      const updateQuarter = {
        ...
        [name]: value,
        total:
          formState.section2.quarter.quarter3.month1 +
          formState.section2.quarter.quarter3.month2 +
          formState.section2.quarter.quarter3.month3,
      };
    ...
    if (props.quarterSelect == 4) {
      const updateQuarter = {
        ...
        [name]: value,
        total:
          formState.section2.quarter.quarter4.month1 +
          formState.section2.quarter.quarter4.month2 +
          formState.section2.quarter.quarter4.month3,
      };
            ...
            <thead>
              <tr>
                <th
                  ...
                  className={`${
                    props.quarterSelect == 1 ? "quarter-selected" : ""
                  }`}
                ...
                <th
                  ...
                  className={`${
                    props.quarterSelect == 2 ? "quarter-selected" : ""
                  }`}
                  style={{ textAlign: "center", cursor: "pointer" }}
                  scope="col"
                >
                ...
                <th
                  ...
                  className={`${
                    props.quarterSelect == 3 ? "quarter-selected" : ""
                  }`}
                  style={{ textAlign: "center", cursor: "pointer" }}
                  scope="col"
                >
                ...
                <th
                  ...
                  className={`${
                    props.quarterSelect == 4 ? "quarter-selected" : ""
                  }`}
                  style={{ textAlign: "center", cursor: "pointer" }}
                  scope="col"
                >
            ...
            <tbody>
              ...
              <tr>
                ...
                <td colSpan={2}>
                  <input
                    disabled
                    onChange={(event) => handleChangeField2(event)}
                    value={
                      props.quarterSelect == 1
                        ? checkNan(
                            formattedValue(
                              formState.section2.quarter.quarter1.total
                            )
                          )
                        : props.quarterSelect == 2
                        ? checkNan(
                            formattedValue(
                              formState.section2.quarter.quarter2.total
                            )
                          )
                        : props.quarterSelect == 3
                        ? checkNan(
                            formattedValue(
                              formState.section2.quarter.quarter3.total
                            )
                          )
                        : props.quarterSelect == 4
                        ? checkNan(
                            formattedValue(
                              formState.section2.quarter.quarter4.total
                            )
                          )
                        : 0
                    }
                ...
                <td colSpan={2}>
                  <input
                    ...
                    value={
                      props.quarterSelect == 1
                        ? checkNan(
                            formState.section2.quarter.quarter1.porportion
                          )
                        : props.quarterSelect == 2
                        ? checkNan(
                            formState.section2.quarter.quarter2.porportion
                          )
                        : props.quarterSelect == 3
                        ? checkNan(
                            formState.section2.quarter.quarter3.porportion
                          )
                        : props.quarterSelect == 4
                        ? checkNan(
                            formState.section2.quarter.quarter4.porportion
                          )
                        : 0
                    }
                    name="porportion"
