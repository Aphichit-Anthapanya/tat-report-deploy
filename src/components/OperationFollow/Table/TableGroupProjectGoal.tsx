...
export default function TableGroupProjectGoal({onChangeTableGroupProjectGoal}:TableProjectIndicatorProps){
                        ...
                        <div className="table-summary-content">
                            <table className="table">
                                ...
                                <tr>
                                    ...
                                    <th style={{textAlign: 'center'}}  scope="col">กลุ่มเป้าหมาย</th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td><input onChange={(e) => handleChangeField(e)} type="text" name="target_name" value={addField.target_name} className="form-control purchase-project-feild1" placeholder="" id="filterOverall" style={{width: '80%', margin: 'auto'}} /></td>
                                </tr>
                                <tr>
