...
export default function TableOperationArea({onChangeTableOperationArea}:TableOperationAreaProps){
                        ...
                        <div className="table-summary-content">
                            <table className="table">
                                ...
                                <tr key={index}>
                                    <td>{index + 1}</td>
                                    <td>
                                    <i onClick={() => handleRemoveRow((data.indx) + '') } style={{color:'red', cursor: 'pointer'}} className="bi bi-trash-fill"></i>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td><input onChange={(e) => handleChangeField(e)} type="text" name="country_area" value={addField.country_area} className="form-control purchase-project-feild1" placeholder="" id="filterOverall" style={{width: '80%', margin: 'auto'}} /></td>
                                    <td><input onChange={(e) => handleChangeField(e)} type="text" name="province" value={addField.province} className="form-control purchase-project-feild1" placeholder="" id="filterOverall" style={{width: '80%', margin: 'auto'}} /></td>
                                </tr>
                                <tr>
                                    <td style={{textAlign: 'center',fontWeight: 'bold'}} colSpan={4}>
