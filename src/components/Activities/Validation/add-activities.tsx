export const checkValidity = (
    ...
    const checkActivitySharedByProjectValid = formState.activity_shared_by_project == '' ? false: true
    ...
    const checkTableOperationAreaValid = tableProjectIndicatorData.length == 0 ? false: true
    const checkTableProjectIndicatorValid = tableOperationAreaData.length == 0 ? false: true
    const checkActivityDescriptionValid = formState.activity_description == '' ? false: true
