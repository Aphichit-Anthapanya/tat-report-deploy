...
import { updateFormField, appendActivity } from "@/redux/OperationFollow/reducer";
...
export default function AddActivities({onChangeAddActivity}: ActivityProps) {
    ...
    const handleUpdateForm = () => {
        ...
        if(checkValidity(formData,validationState,setValidationState,tableOperationArea,tableProjectIndicator)){
    ...
    return (
        <>
            <div className="d-flex form-group">
                ...
                <label>งบประมาณโครงการ (บาท)<span style={{color:'red'}}> *</span></label>
                </div>
            ...
            <div className="d-flex form-group">
                <div className="form-field-label">
                <label>ลำดับที่กิจกรรม<span style={{color:'red'}}> *</span></label>
                </div>
                <div className="d-flex flex-column form-field-fieldzone">
                    <div className="">
                    <input onChange={(e) => handleChangeField(e)} value={formData.activity_order} name="activity_order" type="text" className="form-control" id="exampleFormControlInput1" placeholder="" />
                    </div>
                    <div>
            ...
            <div className="d-flex form-group">
                ...
                <div className="d-flex flex-column form-field-fieldzone">
                    <div className="">
                    <input type="text" onChange={(e) => handleChangeField(e)} value={formData.activity_name} name="activity_name" className="form-control" id="exampleFormControlTextarea1" />
                    </div>
                    <div>
            ...
            <div className="d-flex form-group">
                <div className="form-field-label">
                <label>หมวดกิจกรรม<span style={{color:'red'}}> *</span></label>
                </div>
                <div className="d-flex flex-column form-field-fieldzone">
                    <div className="">
                    <input type="text" onChange={(e) => handleChangeField(e)} value={formData.catname} name="catname" className="form-control" id="exampleFormControlTextarea1" />
                    </div>
                    <div>
            ...
            <div className="d-flex form-group">
                <div className="form-field-label">
                <label>ประเภทกิจกรรม<span style={{color:'red'}}> *</span></label>
                </div>
                <div className="d-flex flex-column form-field-fieldzone">
                    <div className="">
                    <input type="text" onChange={(e) => handleChangeField(e)} value={formData.activity_type} name="activity_type" className="form-control" id="exampleFormControlTextarea1" />
                    </div>
                    <div>
            ...
            <div className="d-flex form-group">
                ...
                <div className="d-flex flex-column form-field-fieldzone">
                    <div className="">
                    <textarea onChange={(e) => handleChangeField(e)} value={formData.activity_description} name="activity_description" className="form-control" id="exampleFormControlTextarea1" rows={2}></textarea>
                    </div>
                    <div>
                        { validationState[9].isValid == false && 
                        <div className="form-field-fieldzone">
                            <span style={{color:'red'}}>โปรดกรอกข้อมูล{validationState[9].alias}</span>
                        </div>
                        }
                    </div>
                </div>
            ...
            <div className="d-flex form-group">
                <div className="form-field-label">
                <label>ตัวชี้วัดระดับกิจกรรม (Output)<span style={{color:'red'}}> *</span></label>
                </div>
                <div className="d-flex flex-column form-field-fieldzone">
                    <div>
            ...
            <div className="d-flex form-group">
                <div className="form-field-label">
                <label>สัดส่วนกิจกรรมต่อโครงการ<span style={{color:'red'}}> *</span></label>
                </div>
                <div className="d-flex flex-column form-field-fieldzone">
                    <div className="">
                        <input onChange={(e) => handleChangeField(e)} value={formData.activity_shared_by_project} name="activity_shared_by_project" type="text" className="form-control" id="exampleFormControlInput1" placeholder="" />
                    </div>
                    <div>
            ...
            <div className="d-flex form-group">
                <div className="form-field-label">
                <label>ช่วงเวลาจัดกิจกรรม (เริ่มต้น)<span style={{color:'red'}}> *</span></label>
                </div>
                <div className="d-flex flex-column form-field-fieldzone">
                    <div className="">
                    <input onChange={(e) => handleChangeField(e)} value={formData.activity_start} name="activity_start" type="date" className="form-control" id="exampleFormControlInput1" placeholder="" style={{
                    width: '40%',
                    float: 'left',
                    marginRight: '15px'
                }} />
            ...
            <div className="d-flex form-group">
                <div className="form-field-label">
                <label>ช่วงเวลาจัดกิจกรรม (สิ้นสุด)<span style={{color:'red'}}> *</span></label>
                </div>
                <div className="d-flex flex-column form-field-fieldzone">
                    <div className="">
                    <input onChange={(e) => handleChangeField(e)} value={formData.activity_end} name="activity_end" type="date" className="form-control" id="exampleFormControlInput1" placeholder="" style={{
                    width: '40%',
                    float: 'left',
                    marginRight: '15px'
                }} />
            ...
            <div className="d-flex form-group">
                <div className="form-field-label">
                <label>พื้นที่ดำเนินกิจกรรม<span style={{color:'red'}}> *</span></label>
                </div>
                <div className="d-flex flex-column form-field-fieldzone">
                    <div>
            ...
            <div className="button-section">
                <button onClick={handleUpdateForm} type="button" className="btn btn-success">ส่งอนุมัติ</button>
                <button type="button" className="btn btn-primary"><i className="bi bi-file-earmark"></i> บันทึกข้อมูลชั่วคราว </button>
                <button onClick={onChangeAddActivity} type="button" className="btn btn-primary"><i className="bi bi-chevron-left"></i> ย้อนกลับ </button>
            </div>
        </>
    )
}