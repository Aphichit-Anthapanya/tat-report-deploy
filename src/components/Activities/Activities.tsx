                ...
                <div className="table-summary-wrapper">
                        <div className="table-summary-content">
                            <table className="table activity-list-table">
                                <thead>
                                <tr>
                                    <th style={{width:'10%'}}  scope="col">ดูช้อมูล</th>
                                    <th style={{width:'10%'}}  scope="col">รายงานผล</th>
                            ...
                            <div className="d-flex justify-content-center activity-select-buttonzone">
                                <div>
                                <button onClick={onChangeAddActivity} className="btn btn-primary" type="submit"><i className="bi bi-file-earmark-plus"></i> เพิ่ม</button>

                                {isEdit == false &&
                                    <>
                                        <button onClick={handleSubmitForm} className="btn btn-primary" type="submit"><i className="bi bi-file-earmark-plus"></i> ส่งอนุมัติ</button>
                                    </>
                                }
                                {isEdit == true &&
                                    <>
                                        <button onClick={handleEditForm} className="btn btn-primary" type="submit"><i className="bi bi-file-earmark-plus"></i> บันทึกการแก้ไข</button>
                                    </>
                                }                               
