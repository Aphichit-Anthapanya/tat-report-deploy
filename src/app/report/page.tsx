                                    ...
                                    <table className="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <th rowSpan={6}>
                                                    <div className="normalText d-flex justify-content-center align-items-center">
                                                        จัดหาและบํารุงเครื่องคอมพิวเตอร์แม่ข่าย Oracle SPARC T๔-๔ พร้อม License
                                                    </div>
                                                </th>
                                                <th rowSpan={6}>
                                                    <div className="normalText d-flex justify-content-center align-items-center">งานระบบเครือข่าย</div>
                                                </th>
                                                <th rowSpan={6}>
                                                    <div className="wd-25 normalText d-flex justify-content-center align-items-center">กคค.</div>
                                                </th>
                                                <th rowSpan={6}>
                                                    <div className="normalText d-flex justify-content-center align-items-center">
                                                        1,000,000.00
                                            ...
                                            <tr>
                                                ...
                                                <th rowSpan={6}>
                                                    <div className="normalText d-flex justify-content-center align-items-center">
                                                        จัดหาเครื่องคอมพิวเตอร์และอุปกรณ์คอมพิวเตอร์
                                                    </div>
                                                </th>
                                                <th rowSpan={6}>
                                                    <div className="normalText d-flex justify-content-center align-items-center">งานระบบเครือข่าย</div>
