                                    ...
                                    <table className="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <th rowSpan={6}>
                                                    <div className="normalText d-flex justify-content-center align-items-center">
                                                        จ้างเหมาบริการให้ความเห็นเกี่ยวกับการปฏิบัติงานด้านการบริหารและกฎหมาย
                                                    </div>
                                                </th>
                                                <th rowSpan={6}>
                                                ...
                                                <th rowSpan={6}>
                                                    <div className="wd-25 normalText d-flex justify-content-center align-items-center">กกร.</div>
                                                </th>
                                                <th rowSpan={6}>
                                                    <div className="normalText d-flex justify-content-center align-items-center">
                                                        600,000.00
                                            ...
                                            <tr>
                                                ...
                                                <th rowSpan={6}>
                                                    <div className="normalText d-flex justify-content-center align-items-center">
                                                        ค่าซื้อผงหมึกเครื่องพิมพ์ ยี่ห้อ OKI สำรองคลังพัสดุ
                                                    </div>
                                                </th>
                                                <th rowSpan={6}>
                                                ...
                                                <th rowSpan={6}>
                                                    <div className="wd-25 normalText d-flex justify-content-center align-items-center">กบจ.</div>
                                                </th>
                                                <th rowSpan={6}>
                                                    <div className="normalText d-flex justify-content-center align-items-center">
                                                        600,000.00
