                ...
                <div className="breadcrumb-zone">นำเข้าข้อมูล {'>'} <span className="bread-crumb-page-name">ข้อมูลโครงการของงานบริหารองค์กร</span> {'>'} <span className="bread-crumb-page-name"><b>โครงการพัฒนาระบบแพลตฟอร์มกลาง ททท. (Single Sign on)</b></span></div>
                    ...
                    <div className='search-wrapper-section d-flex flex-column justify-content-center align-items-center'>
                        <div className="d-flex flex-column mr-20 ml-30">
                            ...
                            <div className="wid d-flex flex-row mb-20">
                                <div className="wdth-200 mr-20 d-flex flex-row justify-content-right">งบประมาณโครงการแผน(บาท)<div className="fontColor">*</div>:</div>
                                <div>7,000,000</div>
                            </div>
                            <div className="wid d-flex flex-row mb-20">
                                    ...
                                    <table className="table table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <th>
                                                    <div className="normalText d-flex justify-content-left align-items-center"><i className="bi bi-pencil"></i></div>
                                                </th>
                                                <th>
                                                    <div className="normalText d-flex justify-content-center align-items-center"></div>
                                                </th>
                                                <th>
                                                    <div className="normalText d-flex justify-content-center align-items-center">การจัดซื้อจัดจ้าง</div>
                                                </th>
                                                <th>
                                                    <div className="normalText d-flex justify-content-center align-items-center">0.00</div>
                                                </th>
                                                <th>
                                                    <div className="normalText d-flex justify-content-center align-items-center">03/01/2566</div>
                                                </th>
                                                <th>
                                                    <div className="normalText d-flex justify-content-center align-items-center">23/03/2566</div>
                                                </th>
                                                <th></th>
                                                <th>
                                                    <div className="normalText d-flex justify-content-center align-items-center">03/04/2566</div>
                                                </th>
                                            ...
                                            <tr>
                                                ...
                                                <th>
                                                    <div className="normalText d-flex justify-content-center align-items-center">สัญญาเลขที่ จ.179/2566</div>
                                                </th>
                                                <th>
                                                    <div className="normalText d-flex justify-content-center align-items-center">0.00</div>
                                                </th>
                                                ...
                                                <th></th>
                                                <th>
                                                    <div className="normalText d-flex justify-content-center align-items-center">04/04/2566</div>
                                                </th>
                                            </tr>
                                            <tr>
                                                <th>
                                                ...
                                                <th>
                                                    <div className="normalText d-flex justify-content-center align-items-center">ประชุมจัดทำร่าง  TOR</div>
                                                </th>
                                                <th>
                                                    <div className="normalText d-flex justify-content-center align-items-center">0.00</div>
                                                </th>
                                                ...
                                                <th>
                                                    <div className="normalText d-flex justify-content-center align-items-center">29/12/2566</div>
                                                </th>
                                                <th></th>
                                                <th>
                                                    <div className="normalText d-flex justify-content-center align-items-center">10/01/2566</div>
                                                </th>
                                            </tr>
                                        </tbody>
                                    </table>
