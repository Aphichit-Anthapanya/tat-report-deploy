      ...
      {data.map((level1Item: any, level1Index: any) => (
        <React.Fragment key={level1Index}>
          <tr className="table-success">
            <th>
                <div className="normalText d-flex justify-content-center align-items-center">{level1Index+1}</div>
            </th>
            <th>
            ...
            <React.Fragment key={level2UserIndex}>
              {visibleLevels.has(`level1_${level1Item.userGroup}_${level1Index}`) && (
                <tr className="table-warning">
                  <th>
                     <div className="normalText d-flex justify-content-center align-items-center">{level2UserIndex+1}</div>
                  </th>
                  <th>
                      <div className="normalText d-flex justify-content-center align-items-center">
                          <button className="open-button icon-button bi bi-pencil"></button>
                  ...
                  <th>
                      <div className="ml-15 normalText d-flex justify-content-left align-items-center">{level2UserItem.userGroup}</div>
                  </th>
                  <th>
              ...
              {level2UserItem.level3User?.map((level3UserItem: any, level3UserIndex: any) => (
                <React.Fragment key={level3UserIndex}>
                  {visibleLevels.has(`level2_${level2UserItem.userGroup}_${level2UserIndex}`) && (
                    <tr>
                      <th>
                            <div className="normalText d-flex justify-content-center align-items-center">{level3UserIndex+1}</div>
                      </th>
                      <th>
                          <div className="normalText d-flex justify-content-center align-items-center">
                              <button className="open-button icon-button bi bi-pencil"></button>
                      ...
                      <th>
                          <div className="ml-30 normalText d-flex justify-content-left align-items-center">{level3UserItem.userGroup}</div>
                      </th>
                      <th>
