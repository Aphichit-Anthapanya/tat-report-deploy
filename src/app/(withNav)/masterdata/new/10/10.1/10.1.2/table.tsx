                        ...
                        <table className="table table-striped">
                                <thead>
                                    ...
                                    <tr className='table-primary'>
                                        ...
                                        <th>
                                            <div className="wd-300 d-flex justify-content-center align-items-center">ชื่อกลยุทธ์ภาพรวม(TH)</div>
                                        </th>
                                        <th>
                                            <div className="wd-300 d-flex justify-content-center align-items-center">ชื่อกลยุทธ์ภาพรวม(EN)</div>
                                        </th>
                                        <th>
                                ...
                                {data.map((items: any) => (
                                    <tr>
                                        ...
                                        <th>
                                            <div className="normalText d-flex justify-content-center align-items-center">
                                                <button className="open-button icon-button bi bi-file-earmark-text-fill" onClick={() => router.push('/masterdata/new/10/10.1/10.1.2/10.1.2.1')}></button>
                                            </div>
                                        </th>
                                        <th>
