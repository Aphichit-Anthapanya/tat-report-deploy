        ...
        <>
            ...
            <div className="breadcrumb-zone fz-20">Master Data {'>'} <span className="bread-crumb-page-name"><b>Master Plan</b></span></div>
                    ...
                    <div className='search-wrapper-section d-flex flex-column'>
                        ...
                        <h3>ชื่อกลยุทธ์ภาพรวม {'>'} ข้อมูลกลยุทธ์รายภูมิภาค {'>'} ข้อมูลชื่อแผนงาน</h3>
                        <div className="d-flex filter-project-button justify-content-left">
                            ...
                            <div className="p-2"><button className="btn btn-primary" onClick={() => router.push('/masterdata/new/10/10.1/10.1.2/10.1.2.1')}>ย้อนกลับ ข้อมูลกลยุทธ์รายภูมิภาค</button></div>
                        </div>
