    ...
    <div className={`popup ${isOpen ? 'open' : ''}`}>
      <div className="popup-content d-flex flex-column justify-content-center align-items-center ">
            <table className="table table-striped">
                ...
                <tr>
                    <th>
                        <div className="d-flex justify-content-right align-items-center">ชื่อข้อมูลตลาด(TH) :</div>
                    </th>
                    <th>
                        <div className="box">
                            <div className="filter-field">
                                <input type="text" className="form-control" placeholder="" id="filterOverall" value={'ฮอนดูรัส'}/>
                            </div>
                        </div>
                    </th>
                </tr>
