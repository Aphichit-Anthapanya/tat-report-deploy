    ...
    return (
        <>
            <div className='d-flex flex-column' style={{width: '100%'}}>
                <div className="breadcrumb-zone">รายงานแผนปฏิบัติการและการดำเนินงาน {'>'} <span className="bread-crumb-page-name"><b>รายงานสรุปงบประมาณตามแผนรายด้าน ฝ่าย กอง สำนักงาน/งาน</b></span></div>
                    ...
                    <div className='search-wrapper-section d-flex flex-column'>
                        <div className="d-flex justify-content-between justify-content-center align-items-center overflow-auto">
                            <div className="years d-flex flex-column p-2 justify-content-center">
                                <div className="box">
                                    <b>รายงานสรุปงบประมาณตามแผนรายด้าน ฝ่าย กอง สำนักงาน/งาน</b>
                                </div>
                                    ...
                                    <div className="table-responsive">
                                        <table className="table table-bordered">
                                            <tbody>
                                                ...
                                                <th>
                                                    <div className="process-project d-flex justify-content-center align-items-center">หน่วยงาน</div>
                                                </th>
                                                <th>
                                                    <div className="process-project d-flex justify-content-center align-items-center">ชื่อโครงการ</div>
                                                </th>
                                                <th>
                                                    <div className="process-project d-flex justify-content-center align-items-center">ชื่อกลยุทธ์ภาพรวม</div>
                                                </th>
                                                <th>
                                                    <div className="process-project d-flex justify-content-center align-items-center">ชื่อแผนงาน</div>
                                                </th>
                                                <th>
                                                    <div className="process-project d-flex justify-content-center align-items-center">หมวด พ.ร.บ ตัวหนา</div>
                                                </th>
                                                <th>
                                                    <div className="process-project d-flex justify-content-center align-items-center">หมวด พ.ร.บ. ตัวบาง</div>
                                                </th>
                                                <th>
