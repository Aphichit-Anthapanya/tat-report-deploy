...
export const sumMonthTotal = (quarterSelect: number, dispatch: any, tempMask: any, setTempMask: (value:any) => void) => {
  ...
  if(quarterSelect == 1){
          ...
          if(m1 != '0' && m2 != '0' && m3 != '0'){
            const total: string  = (parseInt(m1) + parseInt(m2) + parseInt(m3)).toString()
                    ...
                    section2: {
                        ...
                        quarter: {
                            ...
                            quarter1: {
                                ...
                                total: total,
                                porportion: ((parseFloat(total)/parseFloat(formState.section2.budget))*100).toFixed(2).toString()
                            }
                        }
                    }
            }))
